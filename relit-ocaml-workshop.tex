...
There has been recent research in the field of macros that facilitates abstract reasoning about types and macro responsibility. We have succeeded in implementing expression TLMS in Reason. Omar et all. also developed theory for pattern TLMs, that enable notation extensions within patterns. For our future work, we plan to implement these as an optional feature of Relit.
